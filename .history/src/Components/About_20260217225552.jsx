    ...
    <>
      <div className="AboutPage" translate="no">
        <div className="AboutText">
          ...
          <p translate="no">
            Hola, mi nombre es <b>Francisco Escobar</b> y soy Originario de de la ciudad de Tuxtla Gutiérrez,
            Chiapas. Soy <b>Ingeniero en software,</b> egresado de la Universidad Politécnica de Chiapas <b> como ingeniero en desarrollo de Software</b>. <br />
            <br />
